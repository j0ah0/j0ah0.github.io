...
<style>
  ...
  #gb-app { --gb-who: 84px; --gb-gap: 14px; --gb-measure: 460px; --gb-size: 14px; --gb-lh: 1.7; --gb-set-gap: 0.55em; --gb-item-gap: 0.75em; }
  ...
  #gb-login { opacity: 0.12; transition: opacity 120ms ease; }
  #gb-login:hover { opacity: 0.6; }
